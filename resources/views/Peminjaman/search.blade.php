...
<div class="container-fluid">
    <!-- Tombol Kembali -->
    <a href="{{ route('peminjaman') }}" class="btn btn-outline-primary mb-3 animate__animated animate__fadeInLeft modern-btn">
        ...
        <div class="card-body">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 mb-4 text-center">
                    ...
                    <div id="reader" style="width: 100%; height: 320px; border: 2px dashed #007bff; border-radius: 10px;"></div>
                    <button id="start-scan" class="btn btn-outline-primary mt-3 animate__animated animate__bounceIn modern-btn">Mulai Scan</button>
                    <button id="stop-scan" class="btn btn-outline-danger mt-3 d-none animate__animated animate__bounceIn modern-btn">Berhenti Scan</button>
                </div>
                ...
                <div class="col-12 col-md-6 mb-4">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan Email Anggota">
                        <button class="btn btn-outline-primary animate__animated animate__pulse modern-btn" onclick="searchMemberByEmail()">Cari</button>
                    </div>
...
<script>
    ...
    function startQrCodeScanner() {
        ...
        html5QrCode.start(
            ...
            {
                fps: 10,
                qrbox: { width: 250, height: 250 } // Adjust the qrbox size for mobile
            },
