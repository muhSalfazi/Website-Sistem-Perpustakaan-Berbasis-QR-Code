...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h3 class="card-title fw-semibold">Cari Buku</h3>
            <form action="{{ route('search.book.page') }}" method="GET">
                            ...
                            <div>
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <h6 class="card-title fw-semibold">Member</h6>
                                        <p class="mb-1"><strong>Nama:</strong> {{ $member->first_name }}
                                            {{ $member->last_name }}
                                        </p>
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control"
                        placeholder="Cari berdasarkan judul, penulis, penerbit, atau ISBN" name="search"
